...
elseif(${CUSTOM_SYSTEM_PROCESSOR} STREQUAL "ARM")
    # POWERPC
    if(CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
        SET( ARCH_NATIVE_FLAG "-march=native+sve" CACHE STRING "Additional flag for the compiler capacities detection such as -march=armv8.2-a+sve for example"  )
...
elseif(${CUSTOM_SYSTEM_PROCESSOR} STREQUAL "AURORA")
    SET( ARCH_NATIVE_FLAG "-target ve-linux -fno-vectorize -fno-slp-vectorize -fno-crash-diagnostics -std=c++17" CACHE STRING "Additional flag for the compiler capacities detection such as -target ve-linux -v for example"  )
    set(SXA_FLAGS "${ARCH_NATIVE_FLAG}")

    set(ALL_TYPES "SXA")
elseif(${CUSTOM_SYSTEM_PROCESSOR} STREQUAL "RISCV")
    SET( ARCH_NATIVE_FLAG "-march=rv32" CACHE STRING "Additional flag for the compiler capacities detection such as -target ve-linux -v for example"  )

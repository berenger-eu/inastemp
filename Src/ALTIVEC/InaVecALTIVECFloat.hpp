...
public:
    ...
    inline InaVecALTIVEC exp10() const {
        const __vector float COEFF_LOG210 = vec_splats(float(InaFastExp::CoeffLog210()));
        const __vector float COEFF_A     = vec_splats(float(InaFastExp::CoeffA32()));
        const __vector float COEFF_B     = vec_splats(float(InaFastExp::CoeffB32()));
        const __vector float COEFF_P5_A  = vec_splats(float(InaFastExp::GetCoefficient6_5()));
        const __vector float COEFF_P5_B  = vec_splats(float(InaFastExp::GetCoefficient6_4()));
        ...
        __vector float x = vec * COEFF_LOG210;
    ...
    inline static InaVecALTIVEC<float> Fma(const InaVecALTIVEC<float>& inValAdd, const InaVecALTIVEC<float>& inValMul1, const InaVecALTIVEC<float>& inValMul2){

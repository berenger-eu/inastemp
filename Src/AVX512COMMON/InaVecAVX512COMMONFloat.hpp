...
public:
    ...
    inline InaVecAVX512COMMON exp10() const {
         const __m512 COEFF_LOG210 = _mm512_set1_ps(float(InaFastExp::CoeffLog210()));
         const __m512 COEFF_A     = _mm512_set1_ps(float(InaFastExp::CoeffA32()));
         const __m512 COEFF_B     = _mm512_set1_ps(float(InaFastExp::CoeffB32()));
         const __m512 COEFF_P5_A  = _mm512_set1_ps(float(InaFastExp::GetCoefficient6_5()));
         const __m512 COEFF_P5_B  = _mm512_set1_ps(float(InaFastExp::GetCoefficient6_4()));
         ...
         __m512 x = _mm512_mul_ps(vec, COEFF_LOG210);
    ...
    inline InaVecAVX512COMMON exp10LowAcc() const {
        const __m512 COEFF_LOG210 = _mm512_set1_ps(float(InaFastExp::CoeffLog210()));
        const __m512 COEFF_A     = _mm512_set1_ps(float(InaFastExp::CoeffA32()));
        const __m512 COEFF_B     = _mm512_set1_ps(float(InaFastExp::CoeffB32()));
        const __m512 COEFF_P5_D  = _mm512_set1_ps(float(InaFastExp::GetCoefficient3_2()));
    ...
    inline InaVecAVX512COMMON<float> sin() const{
        InaMath<InaVecAVX512COMMON<float>> a;
        return a.sin(*this);
    }
    inline InaVecAVX512COMMON<float> cos() const{
        InaMath<InaVecAVX512COMMON<float>> a;
        return a.cos(*this);
    }
    inline InaVecAVX512COMMON<float> tan() const{
        InaMath<InaVecAVX512COMMON<float>> a;
        return a.tan(*this);
    }
    inline InaVecAVX512COMMON<float> asin() const{
        InaMath<InaVecAVX512COMMON<float>> a;
        return a.asin(*this);
    }
    inline InaVecAVX512COMMON<float> acos() const{
        InaMath<InaVecAVX512COMMON<float>> a;
        return a.acos(*this);
    }
    inline InaVecAVX512COMMON<float> atan() const{
        InaMath<InaVecAVX512COMMON<float>> a;
        return a.atan(*this);
    }
    inline InaVecAVX512COMMON<float> sinh() const{
        InaMath<InaVecAVX512COMMON<float>> a;
        return a.sinh(*this);
    }
    inline InaVecAVX512COMMON<float> cosh() const{
        InaMath<InaVecAVX512COMMON<float>> a;
        return a.cosh(*this);
    }
    inline InaVecAVX512COMMON<float> tanh() const{
        InaMath<InaVecAVX512COMMON<float>> a;
        return a.tanh(*this);
    }
    inline InaVecAVX512COMMON<float> asinh() const{
        InaMath<InaVecAVX512COMMON<float>> a;
        return a.asinh(*this);
    }
    inline InaVecAVX512COMMON<float> acosh() const{
        InaMath<InaVecAVX512COMMON<float>> a;
        return a.acosh(*this);
    }
    inline InaVecAVX512COMMON<float> atanh() const{
        InaMath<InaVecAVX512COMMON<float>> a;
        return a.atanh(*this);
    }
    ...
    inline static InaVecAVX512COMMON<float> Fma(const InaVecAVX512COMMON<float>& inValAdd, const InaVecAVX512COMMON<float>& inValMul1, const InaVecAVX512COMMON<float>& inValMul2){
        return _mm512_fmadd_ps(inValMul1.vec,inValMul2.vec, inValAdd.vec);
    }
};

...
// Mask type
template <>
class InaVecMaskRISCV<double> {
    unsigned char maskData[2048/sizeof(unsigned char)];
    vbool8_t &mask;

public:
    // Classic constructors
    inline InaVecMaskRISCV() : mask(*reinterpret_cast<vbool8_t*>(maskData)){}
    ...
    inline InaVecMaskRISCV Not() const{
        ...
        return vmxor_mm_b8(mask,masktrue);
    }
    ...
    inline static InaVecMaskRISCV NotAnd(const InaVecMaskRISCV& inMask1, const InaVecMaskRISCV& inMask2){
        ...
        vfloat64m8_t vzero = vle64_v_f64m8(values);
        vbool8_t masktrue = vmfeq_vv_f64m8_b8(vzero,vzero);
        return vmnand_mm_b8(vmxor_mm_b8(inMask1.mask,masktrue),inMask2.mask);
    }
...
public:
    ...
    inline InaVecRISCV() : vec(*reinterpret_cast<vfloat64m8_t*>(vecData)) {}
...
// TODO a faire pour la suite
    ...
    inline InaVecRISCV signOf() const {
        ...
        vfloat64m8_t vzero = vle64_v_f64m8(values);
        vbool8_t maskPositive = vmflt_vv_f64m8_b8(vzero,vec);
        vbool8_t maskNegative = vmfgt_vv_f64m8_b8(vzero,vec);
    ...
    inline InaVecRISCV isNegative() const {
        ...
        vfloat64m8_t vzero = vle64_v_f64m8(values);
        vbool8_t maskNegative = vmfle_vv_f64m8_b8(vec,vzero);
    ...
    inline InaVecRISCV isPositiveStrict() const {
        ...
        vfloat64m8_t vzero = vle64_v_f64m8(values);
        vbool8_t maskPositive = vmfgt_vv_f64m8_b8(vec,vzero);
    ...
    inline InaVecRISCV isNegativeStrict() const {
        ...
        vfloat64m8_t vzero = vle64_v_f64m8(values);
        vbool8_t maskNegative = vmflt_vv_f64m8_b8(vec,vzero);
    ...
    inline InaVecRISCV isNotZero() const {
      ...
      return vmerge_vvm_f64m8(maskNotEqual,vzero,vNotEqual);
    }
    ...
    inline static InaVecRISCV IsLowerOrEqual(const InaVecRISCV& inVec1, const InaVecRISCV& inVec2) {
        ...
        return vmerge_vvm_f64m8(mask,vecZero,vecOne);
    }
    ...
    inline static InaVecRISCV IfElse(const InaVecMaskRISCV<double>& inMask, const InaVecRISCV& inIfTrue, const InaVecRISCV& inIfFalse) {
        return vmerge_vvm_f64m8(vbool8_t(inMask),inIfTrue.vec,inIfFalse.vec);
    }

    inline static InaVecRISCV IfTrue(const InaVecMaskRISCV<double>& inMask, const InaVecRISCV& inIfTrue) {
        return vfmerge_vfm_f64m8(vbool8_t(inMask),inIfTrue.vec,0);
    }
    ...
    inline static InaVecRISCV IfFalse(const InaVecMaskRISCV<double>& inMask, const InaVecRISCV& inIfFalse) {
        ...
        vuint64m8_t index = vle64_v_u64m8(tabIndex);
        vfloat64m8_t vecZero = vlxei64_v_f64m8(&zero,index);
        return vmerge_vvm_f64m8(vbool8_t(inMask),vecZero,inIfFalse.vec);
    }
